...
public class HomeworkController {
    ...
    public List<Integer> homework1(){
        ...
        List<Book> books = bookService.findBookedBook();
    ...
    public List<Title> homework2(){
        ...
        List<Title> iliad = new LinkedList<>();
        List<Title> odyssey = new LinkedList<>();

        iliad = titleService.findTitleByName("iliad");
        odyssey = titleService.findTitleByName("Odyssey");

        titles.addAll(iliad);
        titles.addAll(odyssey);
    ...
    public Integer homework3(){
        ...
        count = bookService.findBookByCallnumber("Call123").size();
    ...
    public List<String> homework4(){
        ...
        callnumbers = bookService.findCallnumbersLessThanNum(2);
