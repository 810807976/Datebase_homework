...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> findBookedBook() {
        return bookRepository.findBookedBook();
    }

    @Override
    public List<Book> findBookByCallnumber(String callnumber) {
        return bookRepository.findBookByCallnumber(callnumber);
    }

    @Override
    public List<String> findCallnumbersLessThanNum(Integer num) {
        return bookRepository.findCallnumbersLessThanNum(num);
    }
